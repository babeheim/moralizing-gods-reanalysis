...
hist(1000*out[,6],col="gray",breaks="FD",xlim=c(-15,5),ylim=c(0,80),xlab="Rate of increase in social complexity after - before moralizing gods (SC/ky)", ylab="Frequency")
