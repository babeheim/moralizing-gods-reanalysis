...
files <- c(files, list.files("./12_causal_analysis/forward_bias_output", pattern = ".", full.names = TRUE))
files <- c(files, list.files("./12_causal_analysis/hierarchical_models_output/", pattern = ".", full.names = TRUE))
files <- c(files, list.files("./13_MG_writing_analysis/output", pattern = ".", full.names = TRUE))
